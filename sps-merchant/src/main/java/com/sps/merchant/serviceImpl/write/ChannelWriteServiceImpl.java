...
public class ChannelWriteServiceImpl implements ChannelWriteService{
	...
	@Resource
	private SpsChannelFinanceTargetWriteMapper financeTargetWrit;
	@Resource
	...
	public HashMap<String, String> insertChanel(SpsChannel channel) {
		...
		channelWrite.insertSelective(channel);
	...
	@Override
	public HashMap<String, Object> insertGather(SpsChannelGather gather, String channelNum) {
