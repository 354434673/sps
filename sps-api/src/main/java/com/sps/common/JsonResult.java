...
public class JsonResult {
    ...
    public static JsonResult createSuccessApi(Object obj) {
        JsonResult jp = new JsonResult();
        jp.setMsg(ReturnCode.ACTIVE_SUCCESS.getMsg());
        jp.setResult(obj);
        jp.setSuccess(Boolean.TRUE);
        jp.setCode(ReturnCode.ACTIVE_SUCCESS.getCode() + "");
        return jp;
    }
    ...
    public static JsonResult createFaildApi() {
        JsonResult jp = new JsonResult();
        jp.setMsg(ReturnCode.ACTIVE_FAILURE.getMsg());
        jp.setSuccess(Boolean.FALSE);
        jp.setCode(ReturnCode.ACTIVE_FAILURE.getCode() + "");
        return jp;
    }
    ...
    public static JsonResult returnFaildSys() {
        JsonResult jp = new JsonResult();
        jp.setMsg(ReturnCode.ACTIVE_EXCEPTION.getMsg());
        jp.setSuccess(Boolean.FALSE);
        jp.setCode(ReturnCode.ACTIVE_EXCEPTION.getCode() + "");
        return jp;
    }
