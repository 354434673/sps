...
public enum ResultCodeEnum {
	...
	SYSPARAMERROR_CORP_EXISTS_TIP(1022, "企业名称已存在。"),
	...
	USER_TOURIST_TOLOGIN(2010,"您当前为游客模式，请登录"),
	...
	PAY_SUCCESS(0,"订单数据组装成功"),
	PAY_ERROR(5006,"订单支付失败,请联系管理员"),
	INSTRUMENT_READY(5007,"所选器具已在检测中，请重新选择"),
	ORDER_ERROR(5008,"委托单异常"),
	ORDER_INS_ERROR(5009,"器具还在检测中,请重新选择"),
	/*********************************** 订单结束 ***********************************/
