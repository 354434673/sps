...
public interface GoodSkuService {
     ...
     * @return
     */
    HashMap<String,Object> findGoodSkuList(Integer page, Integer limit, String goodsName, String spuNo, String size, Integer auditStatus);
     ...
     * @param goodSku
     */
    void updateType(SpsGoodSku goodSku);
}
