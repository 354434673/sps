...
public class JedisClientSingle {
	...
	//private static JedisClientSingle single=null;

	private Logger logger = LoggerFactory.getLogger(JedisClientSingle.class);

//	public static JedisClientSingle getInstance() {
//		if (JedisClientSingle.single==null) {
//			JedisClientSingle.single = new JedisClientSingle();
//		}
//		return JedisClientSingle.single;
//	}

	public JedisClientSingle(){
		logger.debug("初始化 {}", JedisClientSingle.class);
	}
