...
public class CommonUtil {
	 ...
	 * @throws IOException
	 */
	public static String saveFile(MultipartFile[] myfiles, String path, String imgName) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void saveFiles(List<CommonsMultipartFile> files, String path, List<String> names) throws IOException {
		for (int i = 0; i < files.size(); i++) {
			if (!files.get(i).isEmpty()) {
				FileUtils.copyInputStreamToFile(files.get(i).getInputStream(), new File(path, names.get(i)));
			}
		}
	}
	...
	public static Map<String, Object> uploadManyPicture(
	...
	public static Map<String, Object> uploadPicture(MultipartFile file, 
