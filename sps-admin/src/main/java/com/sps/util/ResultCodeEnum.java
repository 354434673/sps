...
public enum ResultCodeEnum {
	...
	PAYBACK_SUCCESS(5003,"订单支付成功"),
	PAYBACK_ERROR(5004,"订单支付失败"),
	PAY_SUCCESS(5005,"订单支付失败"),
	...
	/********************************* 短信相关开始 ************************************/
	SMS_CONTENT_UP_LIMIT(7001, "短信内容必须在200字符以下"),
	SMS_SOURCE_MISSTAKE(7002, "source参数错误"),
	SMS_PHONE_MISSTAKE(7003, "手机号格式错误"),
	SMS_SIGN_NOT_VALID(7004, "签名不正确"),
	/********************************* 短信相关结束 ************************************/	
	
	/********************************* 消息中心开始开始 ************************************/
	Target_NOT_EXIST(8001, "发送目标不存在"),
	Token_NotEXIST(8002,"Token不存在"),
	Request_LenthNotEqual(8003,"names，refererIds，secondIds，secondStatuss数组长度要相等且不能为0"),
	
	/********************************* 微信绑定账户开始 ************************************/
	
	ACCOUNT_WITHDRAW_ERROR(9001, "账户提现异常"),
	ACCOUNT_PWD_ERROR(9002, "获取手势密码失败"),
	ACCOUNT_WITHDRAW_GREATER(9003, "账户提现金额大于余额"),
	ACCOUNT_BANKBIND_ERROK(9004, "账户只能绑定一张卡"),
