...
public class QRCodeFactory {
     ...
     * @return 
      ...
      */
     public  BufferedImage CreatQrImage(String content,OutputStream os, int ...size ) throws IOException, WriterException{
        ...
        BufferedImage writeToFile = MatrixToImageWriter.writeToFile(bitMatrix, os);
