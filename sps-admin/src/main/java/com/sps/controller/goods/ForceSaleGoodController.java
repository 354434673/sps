...
public class ForceSaleGoodController {
    ...
    @ResponseBody
    public HashMap<String, Object> goodsList(Integer page, Integer limit, String spuNo, String goodsName,String shopName,String shopNumber, Integer shopStatus, String endTime, String startTime) {
        HashMap<String, Object> goodsList = goodService.findForceGoodsList(page, limit, shopName,goodsName,shopNumber, shopStatus, endTime, startTime, spuNo);
        return goodsList;
    }
