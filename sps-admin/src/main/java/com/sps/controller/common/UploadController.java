...
public class UploadController {
    ...
    public Map<String, Object> uploadPicture(@RequestParam(value = "file", required = false) MultipartFile file,
        ...
        if (fileName != null && fileName != "") {
            String returnUrl = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath() + "/src/main/upload/imgs/";//存储路径
            String path = request.getSession().getServletContext().getRealPath("webapp/upload/imgs"); //文件存储位置
     ...
     * @return
     */
    @RequestMapping(value = "/file/uploadOne")
    @ResponseBody
    public Map<String, Object> uploadOne(@RequestParam(value = "file", required = false) MultipartFile file,
                                             HttpServletRequest request) {
        Map<String, Object> resultMap = new HashMap<>();
        Map<String, Object> map = new HashMap<>();
        File targetFile = null;
