...
<!-- 		  <div class="layui-form-item " >
		 ...
		 <div class="layui-form-item">
		    ...
		    <div class="layui-input-inline">
		      <input id="enterpriseCorpIdcard" type="text" name="enterpriseCorpIdcard"  lay-verify="required|IsIDCard" placeholder="请输入法人代表姓名" autocomplete="off" class="layui-input">
		    </div>
		  </div>
		  <div class="layui-form-item">
