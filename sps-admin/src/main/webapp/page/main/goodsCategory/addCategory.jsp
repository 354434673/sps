    ...
    <div class="layui-form layui-form-pane">
        <input type="hidden" name="categoryParentName"  id="categoryParentName" value="${categoryParentName}">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="categoryUrl" name="categoryUrl" value="${spsGoodCategory.categoryUrl}" placeholder="图片" class="layui-input"/>
...
<script type="text/javascript">
    ...
    layui.use(['form', 'table'], function () {
        ...
        form.on('submit(submitCategory)', function (data) {
            ...
            $.ajax({
                data:{categoryName:categoryName, categoryWeight:categoryWeight, categoryParentId:categoryParentId,
                    categoryDes:categoryDes, categoryUrl:categoryUrl
                },
