            ...
            if (getCheckCode) {
                getCheckCode.addEventListener('click', function () {
                    ...
                    if (telNum.value == '' || telNum.value.length == 0) {
                        ...
                        var telNum = document.getElementById('telNum');
                        aspenLib.ajax({
                            url: location.protocol + "//" + location.hostname + ":8080/sps-admin/user/getPhoneCode/regist",
        ...
        submitInformation: function () {
            ...
            submitBtn.addEventListener('click', function () {
                ...
                if (telNum.value == '' || telNum.value.length == 0) {
                    ...
                    aspenLib.ajax({
                        url: location.protocol + "//" + location.hostname + ":8080/sps-admin/user/h5/regist",
                        //url: location.protocol + "//" + location.hostname + ":/user/h5/regist",
                        type: 'post',
                        dataType: 'json',
                        data: {
                        	saleSrc:'CH123456',
